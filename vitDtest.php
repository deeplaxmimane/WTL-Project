...
$res = mysqli_query($con,"SELECT * FROM vitd where id=$Id");
...
while($row = mysqli_fetch_array($res))
 ...
 echo "<tr>";
 echo "<th width=25%>25-Hydroxyvitamin D</th>";
 echo "<th width=25%>". $row['HD'] ."</th>";
  echo "<th width=25%>nmol/L</th>";
 echo "<th width=25%>75-250</th>";
 echo " <th></th>";
 echo " </tr>";
...
<tr>
<th>Deficient&emsp;&emsp;</th>
<th><25</th>
</tr>

<tr>
<th>Insufficient&emsp;&emsp;</th>
<th>25-74</th>
</tr>

<tr>
<th>Optimal&emsp;&emsp;</th>
<th>75-250</th>
</tr>

<tr>
<th>Excessive&emsp;&emsp;</th>
<th>>250</th>
</tr>
</table>
