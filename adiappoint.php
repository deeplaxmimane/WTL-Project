...
<form name="registration" action="" method="post" >
  ...
  <div class="container__child signup__form">
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="name" id="name" placeholder="Aditi More" required />
      </div>
      
      <div class="form-group">
        <label for="email">Email</label>
        <input class="form-control" type="text" name="email" id="email" placeholder="aditi.more@gmail.com" required />
      </div>
      <div class="form-group">
